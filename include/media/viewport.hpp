...
namespace toybox {
    ...
    namespace detail {
        ...
        struct viewport_image_holder_s {
            viewport_image_holder_s(size_s viewport_size);
    ...
    class viewport_c : public display_item_c, private detail::viewport_image_holder_s, public canvas_c {
    ...
    public:
        ...
        __forceinline type_e display_type() const override __pure { return viewport; }
        
        viewport_c(size_s viewport_size = min_size);
        ~viewport_c();

        point_s offset() const_pure { return _offset; }
        void set_offset(point_s offset);

        __forceinline dirtymap_c* dirtymap() { return _dirtymap; }
        __forceinline const dirtymap_c* dirtymap() const_pure { return _dirtymap; }

    private:
        const detail::display_config_t display_config() const_pure;
        point_s _offset;
    };
